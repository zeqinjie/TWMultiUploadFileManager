...
@interface TWMultiFileManager : NSObject
#pragma mark - 沙盒目录相关
// 沙盒的主目录路径
+ (NSString *)homeDir;
// 沙盒中Documents的目录路径
...
/// 解决办法，直接移动文件到指定 cachesDir 目录《类似剪切》
/// @param srcPath 需要移动的文件目录
/// @param dirPathName 移动到目标目录名称
+ (NSString *)moveVideoFileAtPath:(NSString *)srcPath dirPathName:(NSString *)dirPathName;
